...
public class MainActivityChinese extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textField = (EditText)findViewById (R.id.text_field_chinese);
		convertBtn = (Button)findViewById (R.id.button_convert_chinese);
		englishBtn = (Button)findViewById (R.id.button_english);
		text = (TextView)findViewById (R.id.textView_chinese);
	...
	private String convertInteger (String number) {
		if (number.length () < 5) {
			...
			return convertInteger (firstPart) + thatWord + (addZero? "零" : "") + convertInteger (secondPart);
		}
	}
